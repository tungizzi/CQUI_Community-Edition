...
INSERT OR REPLACE INTO CQUI_Settings -- Don't touch this line!
    VALUES  ("CQUI_AlwaysOpenTechTrees", 1), -- Always opens the full tech trees instead of the civic/research picker panels
        ...
        ("CQUI_RelocateEncampmentStrike", 1), -- Relocate the Encampment Strike button to above the encampment health and defense bars
        ...
        ("CQUI_TechPopupAudio", 0), -- Automatically play the voiceovers when you discover a new tech or civic (this is the normal behavior for the unmoded game)
        ...
        ('CQUI_TraderShowSortOrder', 1), -- Adds a divider between groups in TradeOverview panel
        ('CQUI_ShowProductionRecommendations', 1), -- Shows the advisor recommendation in the city produciton panel
        ...
        ('CQUI_ShowImprovementsRecommendations', 1), -- Shows the advisor recommendation for the builder improvements
        ('CQUI_InlineCityStateQuest', 1), -- Show city state quest below city state name instead of a tooltip
        ('CQUI_ShowCityDetailAdvisor', 1), -- Shows the advisor recommendation in the city detail panel
